...
<html lang="en">
	<head>
		<!-- Basic -->
		<meta charset="utf-8">
		<title>MAGNUS SHOES</title>
		<base href="{{ asset('') }}blog_assets/">
									...
									<div class="responsive-menu mainMenu">									
										...
										<ul class="nav navbar-nav">
											...
											<li class="dropdown dropdown-mega-menu">											
												<a href="index.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">CATEGORIES</span></a>
												<ul class="dropdown-menu megamenu image-links-layout" role="menu">												
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="">
														<span class="figcaption">NIKE</span>
														</a>
														</span>
													</li>
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-02.html">
														<span class="figcaption">ADIDAS</span>
														</a>
													</span>
													</li>
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-03.html">
														<span class="figcaption">PUMA</span>
														</a>
													...
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-04.html">
														<span class="figcaption">LACOSTE</span>
														</a>
													</span>
													</li>												
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-05.html">
														<span class="figcaption">D&G</span>
														</a>
													</span>
													</li>
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-06.html">
														<span class="figcaption">HERMES</span>
														</a>								
													</span>
													</li>												
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-07.html">
														<span class="figcaption">PRADA</span>
														</a>
													</span>
													</li>
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-08.html">
														<span class="figcaption">GUCCI</span>
														</a>
													</span>
													</li>												
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-09.html">
														<span class="figcaption">BITI'S</span>
														</a>
													</span>
													</li>
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-10.html">
														<span class="figcaption">GAP</span>
														</a>
													</span>
													</li>												
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-11.html">
														<span class="figcaption">LEVI'S</span>
														</a>
														</span>
													</li>
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-12.html">
														<span class="figcaption">ZARA</span>
														</a>
													</span>
													</li>
												</ul>
											...
											<li class="dropdown dropdown-mega-menu">
												...
												<a href="listing.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">BRANDS</span></a>
												<ul class="dropdown-menu megamenu image-links-layout" role="menu">												
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="">
														<span class="figcaption">NIKE,Inc.</span>
														</a>
														</span>
													</li>
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-02.html">
														<span class="figcaption">Adidas Ltd AG</span>
														</a>
													</span>
													</li>
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-03.html">
														<span class="figcaption">Puma SE</span>
														</a>
													...
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index-06.html">
														<span class="figcaption">Biti's VietNam</span>
														</a>								
													</span>
													</li>												
											...
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="listing.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">FAQ</span></a>
											</li>
										</ul>
									</div>
								</nav>
